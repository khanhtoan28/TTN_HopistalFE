...
export const goldenBookService = {
  getAll: async (): Promise<BaseResponse<GoldenBook[]>> => {
    return apiClient.get<GoldenBook[]>(API_ENDPOINTS.GOLDEN_BOOK.BASE, false); // Public GET, không cần auth
  },

  getById: async (id: number): Promise<BaseResponse<GoldenBook>> => {
    return apiClient.get<GoldenBook>(API_ENDPOINTS.GOLDEN_BOOK.BY_ID(id), false); // Public GET, không cần auth
  },
...
export const artifactsService = {
  getAll: async (): Promise<BaseResponse<Artifact[]>> => {
    return apiClient.get<Artifact[]>(API_ENDPOINTS.ARTIFACTS.BASE, false); // Public GET, không cần auth
  },

  getById: async (id: number): Promise<BaseResponse<Artifact>> => {
    return apiClient.get<Artifact>(API_ENDPOINTS.ARTIFACTS.BY_ID(id), false); // Public GET, không cần auth
  },
...
export const historyService = {
  getAll: async (): Promise<BaseResponse<History[]>> => {
    return apiClient.get<History[]>(API_ENDPOINTS.HISTORIES.BASE, false); // Public GET, không cần auth
  },

  getById: async (id: number): Promise<BaseResponse<History>> => {
    return apiClient.get<History>(API_ENDPOINTS.HISTORIES.BY_ID(id), false); // Public GET, không cần auth
  },
...
export const introductionService = {
  getAll: async (): Promise<BaseResponse<Introduction[]>> => {
    return apiClient.get<Introduction[]>(API_ENDPOINTS.INTRODUCTIONS.BASE, false); // Public GET, không cần auth
  },

  getById: async (id: number): Promise<BaseResponse<Introduction>> => {
    return apiClient.get<Introduction>(API_ENDPOINTS.INTRODUCTIONS.BY_ID(id), false); // Public GET, không cần auth
  },
